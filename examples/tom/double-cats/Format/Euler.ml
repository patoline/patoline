...
let changeFont l=
  Env (fun (env1,env2,env3,env4,env5,env6,env7,env8)->
         ({ env1 with mathsSubst=compose (subst l) env1.mathsSubst },
          { env2 with mathsSubst=compose (subst l) env2.mathsSubst },
          { env3 with mathsSubst=compose (subst l) env3.mathsSubst },
          { env4 with mathsSubst=compose (subst l) env4.mathsSubst },
          { env5 with mathsSubst=compose (subst l) env5.mathsSubst },
          { env6 with mathsSubst=compose (subst l) env6.mathsSubst },
          { env7 with mathsSubst=compose (subst l) env7.mathsSubst },
          { env8 with mathsSubst=compose (subst l) env8.mathsSubst })
      )
