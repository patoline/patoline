(** Implements the algorithm used by TeX82 to hyphenate words *)
...
(** This structure is nothing more than a patricia tree of hyphenations *)
type ptree =
    Node of char array * ptree C.t
  | Exception of string list * ptree C.t

(** Empty hyphenation tree *)
val empty:ptree

(** Inserts a normal pattern in the tree *)
