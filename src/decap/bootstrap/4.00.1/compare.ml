...
and eq_expression_desc c1 c2 =
  ...
  | Pexp_open(x1,x2), Pexp_open(y1,y2) -> true && ((eq_loc eq_longident) x1 y1) && (eq_expression x2 y2)  | _, _ -> false
...
and eq_signature_item_desc c1 c2 =
  ...
  | Psig_modtype(x1,x2), Psig_modtype(y1,y2) -> true && ((eq_loc (=)) x1 y1) && (eq_modtype_declaration x2 y2)  | Psig_open(x), Psig_open(y) -> (eq_loc eq_longident) x y
...
and eq_structure_item_desc c1 c2 =
  ...
  | Pstr_modtype(x1,x2), Pstr_modtype(y1,y2) -> true && ((eq_loc (=)) x1 y1) && (eq_module_type x2 y2)  | Pstr_open(x), Pstr_open(y) -> (eq_loc eq_longident) x y
