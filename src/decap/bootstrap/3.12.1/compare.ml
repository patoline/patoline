...
and eq_row_field c1 c2 =
  ...
  | _, _ -> false
let eq_class_infos : 'a. ('a -> 'a -> bool) -> 'a class_infos -> 'a class_infos -> bool = fun eq_a r1 r2 -> true && eq_virtual_flag r1.pci_virt r2.pci_virt && (fun (x1,x2) (y1,y2) -> true && ((eq_list (=)) x1 y1) && ((fun _ _ -> true) x2 y2)) r1.pci_params r2.pci_params && (=) r1.pci_name r2.pci_name && eq_a r1.pci_expr r2.pci_expr && (eq_list (fun (x1,x2) (y1,y2) -> true && ((=) x1 y1) && ((=) x2 y2))) r1.pci_variance r2.pci_variance && (fun _ _ -> true) r1.pci_loc r2.pci_loc
...
and eq_pattern_desc c1 c2 =
  ...
  | Ppat_var(x), Ppat_var(y) -> (=) x y
  | Ppat_alias(x1,x2), Ppat_alias(y1,y2) -> true && (eq_pattern x1 y1) && ((=) x2 y2)  | Ppat_constant(x), Ppat_constant(y) -> eq_constant x y
  | Ppat_tuple(x), Ppat_tuple(y) -> (eq_list eq_pattern) x y
  | Ppat_construct(x1,x2,x3), Ppat_construct(y1,y2,y3) -> true && (eq_longident x1 y1) && ((eq_option eq_pattern) x2 y2) && ((=) x3 y3)  | Ppat_variant(x1,x2), Ppat_variant(y1,y2) -> true && (eq_label x1 y1) && ((eq_option eq_pattern) x2 y2)  | Ppat_record(x1,x2), Ppat_record(y1,y2) -> true && ((eq_list (fun (x1,x2) (y1,y2) -> true && (eq_longident x1 y1) && (eq_pattern x2 y2))) x1 y1) && (eq_closed_flag x2 y2)  | Ppat_array(x), Ppat_array(y) -> (eq_list eq_pattern) x y
  | Ppat_or(x1,x2), Ppat_or(y1,y2) -> true && (eq_pattern x1 y1) && (eq_pattern x2 y2)  | Ppat_constraint(x1,x2), Ppat_constraint(y1,y2) -> true && (eq_pattern x1 y1) && (eq_core_type x2 y2)  | Ppat_type(x), Ppat_type(y) -> eq_longident x y
...
and eq_expression_desc c1 c2 =
  match c1, c2 with
  | Pexp_ident(x), Pexp_ident(y) -> eq_longident x y
  ...
  | Pexp_construct(x1,x2,x3), Pexp_construct(y1,y2,y3) -> true && (eq_longident x1 y1) && ((eq_option eq_expression) x2 y2) && ((=) x3 y3)  | Pexp_variant(x1,x2), Pexp_variant(y1,y2) -> true && (eq_label x1 y1) && ((eq_option eq_expression) x2 y2)  | Pexp_record(x1,x2), Pexp_record(y1,y2) -> true && ((eq_list (fun (x1,x2) (y1,y2) -> true && (eq_longident x1 y1) && (eq_expression x2 y2))) x1 y1) && ((eq_option eq_expression) x2 y2)  | Pexp_field(x1,x2), Pexp_field(y1,y2) -> true && (eq_expression x1 y1) && (eq_longident x2 y2)  | Pexp_setfield(x1,x2,x3), Pexp_setfield(y1,y2,y3) -> true && (eq_expression x1 y1) && (eq_longident x2 y2) && (eq_expression x3 y3)  | Pexp_array(x), Pexp_array(y) -> (eq_list eq_expression) x y
  | Pexp_ifthenelse(x1,x2,x3), Pexp_ifthenelse(y1,y2,y3) -> true && (eq_expression x1 y1) && (eq_expression x2 y2) && ((eq_option eq_expression) x3 y3)  | Pexp_sequence(x1,x2), Pexp_sequence(y1,y2) -> true && (eq_expression x1 y1) && (eq_expression x2 y2)  | Pexp_while(x1,x2), Pexp_while(y1,y2) -> true && (eq_expression x1 y1) && (eq_expression x2 y2)  | Pexp_for(x1,x2,x3,x4,x5), Pexp_for(y1,y2,y3,y4,y5) -> true && ((=) x1 y1) && (eq_expression x2 y2) && (eq_expression x3 y3) && (eq_direction_flag x4 y4) && (eq_expression x5 y5)  | Pexp_constraint(x1,x2,x3), Pexp_constraint(y1,y2,y3) -> true && (eq_expression x1 y1) && ((eq_option eq_core_type) x2 y2) && ((eq_option eq_core_type) x3 y3)  | Pexp_when(x1,x2), Pexp_when(y1,y2) -> true && (eq_expression x1 y1) && (eq_expression x2 y2)  | Pexp_send(x1,x2), Pexp_send(y1,y2) -> true && (eq_expression x1 y1) && ((=) x2 y2)  | Pexp_new(x), Pexp_new(y) -> eq_longident x y
  | Pexp_setinstvar(x1,x2), Pexp_setinstvar(y1,y2) -> true && ((=) x1 y1) && (eq_expression x2 y2)  | Pexp_override(x), Pexp_override(y) -> (eq_list (fun (x1,x2) (y1,y2) -> true && ((=) x1 y1) && (eq_expression x2 y2))) x y
  | Pexp_letmodule(x1,x2,x3), Pexp_letmodule(y1,y2,y3) -> true && ((=) x1 y1) && (eq_module_expr x2 y2) && (eq_expression x3 y3)  | Pexp_assert(x), Pexp_assert(y) -> eq_expression x y
  ...
  | Pexp_newtype(x1,x2), Pexp_newtype(y1,y2) -> true && ((=) x1 y1) && (eq_expression x2 y2)  | Pexp_pack(x1,x2), Pexp_pack(y1,y2) -> true && (eq_module_expr x1 y1) && (eq_package_type x2 y2)  | Pexp_open(x1,x2), Pexp_open(y1,y2) -> true && (eq_longident x1 y1) && (eq_expression x2 y2)  | _, _ -> false
and eq_value_description = fun r1 r2 -> true && eq_core_type r1.pval_type r2.pval_type && (eq_list (=)) r1.pval_prim r2.pval_prim
and eq_type_declaration = fun r1 r2 -> true && (eq_list (=)) r1.ptype_params r2.ptype_params && (eq_list (fun (x1,x2,x3) (y1,y2,y3) -> true && (eq_core_type x1 y1) && (eq_core_type x2 y2) && ((fun _ _ -> true) x3 y3))) r1.ptype_cstrs r2.ptype_cstrs && eq_type_kind r1.ptype_kind r2.ptype_kind && eq_private_flag r1.ptype_private r2.ptype_private && (eq_option eq_core_type) r1.ptype_manifest r2.ptype_manifest && (eq_list (fun (x1,x2) (y1,y2) -> true && ((=) x1 y1) && ((=) x2 y2))) r1.ptype_variance r2.ptype_variance && (fun _ _ -> true) r1.ptype_loc r2.ptype_loc
and eq_type_kind c1 c2 =
  match c1, c2 with
  | Ptype_abstract, Ptype_abstract -> true
  | Ptype_variant(x), Ptype_variant(y) -> (eq_list (fun (x1,x2,x3) (y1,y2,y3) -> true && ((=) x1 y1) && ((eq_list eq_core_type) x2 y2) && ((fun _ _ -> true) x3 y3))) x y
  | Ptype_record(x), Ptype_record(y) -> (eq_list (fun (x1,x2,x3,x4) (y1,y2,y3,y4) -> true && ((=) x1 y1) && (eq_mutable_flag x2 y2) && (eq_core_type x3 y3) && ((fun _ _ -> true) x4 y4))) x y
  | _, _ -> false
...
and eq_class_type_desc c1 c2 =
  match c1, c2 with
  | Pcty_constr(x1,x2), Pcty_constr(y1,y2) -> true && (eq_longident x1 y1) && ((eq_list eq_core_type) x2 y2)  | Pcty_signature(x), Pcty_signature(y) -> eq_class_signature x y
  | Pcty_fun(x1,x2,x3), Pcty_fun(y1,y2,y3) -> true && (eq_label x1 y1) && (eq_core_type x2 y2) && (eq_class_type x3 y3)  | _, _ -> false
and eq_class_signature c1 c2 = (fun (x1,x2) (y1,y2) -> true && (eq_core_type x1 y1) && ((eq_list eq_class_type_field) x2 y2)) c1 c2
and eq_class_type_field c1 c2 =
  match c1, c2 with
  | Pctf_inher(x), Pctf_inher(y) -> eq_class_type x y
  | Pctf_val(x1,x2,x3,x4,x5), Pctf_val(y1,y2,y3,y4,y5) -> true && ((=) x1 y1) && (eq_mutable_flag x2 y2) && (eq_virtual_flag x3 y3) && (eq_core_type x4 y4) && ((fun _ _ -> true) x5 y5)  | Pctf_virt(x1,x2,x3,x4), Pctf_virt(y1,y2,y3,y4) -> true && ((=) x1 y1) && (eq_private_flag x2 y2) && (eq_core_type x3 y3) && ((fun _ _ -> true) x4 y4)  | Pctf_meth(x1,x2,x3,x4), Pctf_meth(y1,y2,y3,y4) -> true && ((=) x1 y1) && (eq_private_flag x2 y2) && (eq_core_type x3 y3) && ((fun _ _ -> true) x4 y4)  | Pctf_cstr(x1,x2,x3), Pctf_cstr(y1,y2,y3) -> true && (eq_core_type x1 y1) && (eq_core_type x2 y2) && ((fun _ _ -> true) x3 y3)  | _, _ -> false
...
and eq_class_expr_desc c1 c2 =
  match c1, c2 with
  | Pcl_constr(x1,x2), Pcl_constr(y1,y2) -> true && (eq_longident x1 y1) && ((eq_list eq_core_type) x2 y2)  | Pcl_structure(x), Pcl_structure(y) -> eq_class_structure x y
...
and eq_class_structure c1 c2 = (fun (x1,x2) (y1,y2) -> true && (eq_pattern x1 y1) && ((eq_list eq_class_field) x2 y2)) c1 c2
and eq_class_field c1 c2 =
  match c1, c2 with
  | Pcf_inher(x1,x2,x3), Pcf_inher(y1,y2,y3) -> true && (eq_override_flag x1 y1) && (eq_class_expr x2 y2) && ((eq_option (=)) x3 y3)  | Pcf_valvirt(x1,x2,x3,x4), Pcf_valvirt(y1,y2,y3,y4) -> true && ((=) x1 y1) && (eq_mutable_flag x2 y2) && (eq_core_type x3 y3) && ((fun _ _ -> true) x4 y4)  | Pcf_val(x1,x2,x3,x4,x5), Pcf_val(y1,y2,y3,y4,y5) -> true && ((=) x1 y1) && (eq_mutable_flag x2 y2) && (eq_override_flag x3 y3) && (eq_expression x4 y4) && ((fun _ _ -> true) x5 y5)  | Pcf_virt(x1,x2,x3,x4), Pcf_virt(y1,y2,y3,y4) -> true && ((=) x1 y1) && (eq_private_flag x2 y2) && (eq_core_type x3 y3) && ((fun _ _ -> true) x4 y4)  | Pcf_meth(x1,x2,x3,x4,x5), Pcf_meth(y1,y2,y3,y4,y5) -> true && ((=) x1 y1) && (eq_private_flag x2 y2) && (eq_override_flag x3 y3) && (eq_expression x4 y4) && ((fun _ _ -> true) x5 y5)  | Pcf_cstr(x1,x2,x3), Pcf_cstr(y1,y2,y3) -> true && (eq_core_type x1 y1) && (eq_core_type x2 y2) && ((fun _ _ -> true) x3 y3)  | Pcf_let(x1,x2,x3), Pcf_let(y1,y2,y3) -> true && (eq_rec_flag x1 y1) && ((eq_list (fun (x1,x2) (y1,y2) -> true && (eq_pattern x1 y1) && (eq_expression x2 y2))) x2 y2) && ((fun _ _ -> true) x3 y3)  | Pcf_init(x), Pcf_init(y) -> eq_expression x y
  | _, _ -> false
...
and eq_module_type_desc c1 c2 =
  match c1, c2 with
  | Pmty_ident(x), Pmty_ident(y) -> eq_longident x y
  | Pmty_signature(x), Pmty_signature(y) -> eq_signature x y
  | Pmty_functor(x1,x2,x3), Pmty_functor(y1,y2,y3) -> true && ((=) x1 y1) && (eq_module_type x2 y2) && (eq_module_type x3 y3)  | Pmty_with(x1,x2), Pmty_with(y1,y2) -> true && (eq_module_type x1 y1) && ((eq_list (fun (x1,x2) (y1,y2) -> true && (eq_longident x1 y1) && (eq_with_constraint x2 y2))) x2 y2)  | Pmty_typeof(x), Pmty_typeof(y) -> eq_module_expr x y
  | _, _ -> false
...
and eq_signature_item_desc c1 c2 =
  match c1, c2 with
  | Psig_value(x1,x2), Psig_value(y1,y2) -> true && ((=) x1 y1) && (eq_value_description x2 y2)  | Psig_type(x), Psig_type(y) -> (eq_list (fun (x1,x2) (y1,y2) -> true && ((=) x1 y1) && (eq_type_declaration x2 y2))) x y
  | Psig_exception(x1,x2), Psig_exception(y1,y2) -> true && ((=) x1 y1) && (eq_exception_declaration x2 y2)  | Psig_module(x1,x2), Psig_module(y1,y2) -> true && ((=) x1 y1) && (eq_module_type x2 y2)  | Psig_recmodule(x), Psig_recmodule(y) -> (eq_list (fun (x1,x2) (y1,y2) -> true && ((=) x1 y1) && (eq_module_type x2 y2))) x y
  | Psig_modtype(x1,x2), Psig_modtype(y1,y2) -> true && ((=) x1 y1) && (eq_modtype_declaration x2 y2)  | Psig_open(x), Psig_open(y) -> eq_longident x y
  | Psig_include(x), Psig_include(y) -> eq_module_type x y
...
and eq_with_constraint c1 c2 =
  ...
  | Pwith_module(x), Pwith_module(y) -> eq_longident x y
  | Pwith_typesubst(x), Pwith_typesubst(y) -> eq_type_declaration x y
  | Pwith_modsubst(x), Pwith_modsubst(y) -> eq_longident x y
  | _, _ -> false
...
and eq_module_expr_desc c1 c2 =
  match c1, c2 with
  | Pmod_ident(x), Pmod_ident(y) -> eq_longident x y
  | Pmod_structure(x), Pmod_structure(y) -> eq_structure x y
  | Pmod_functor(x1,x2,x3), Pmod_functor(y1,y2,y3) -> true && ((=) x1 y1) && (eq_module_type x2 y2) && (eq_module_expr x3 y3)  | Pmod_apply(x1,x2), Pmod_apply(y1,y2) -> true && (eq_module_expr x1 y1) && (eq_module_expr x2 y2)  | Pmod_constraint(x1,x2), Pmod_constraint(y1,y2) -> true && (eq_module_expr x1 y1) && (eq_module_type x2 y2)  | Pmod_unpack(x1,x2), Pmod_unpack(y1,y2) -> true && (eq_expression x1 y1) && (eq_package_type x2 y2)  | _, _ -> false
...
and eq_structure_item_desc c1 c2 =
  ...
  | Pstr_value(x1,x2), Pstr_value(y1,y2) -> true && (eq_rec_flag x1 y1) && ((eq_list (fun (x1,x2) (y1,y2) -> true && (eq_pattern x1 y1) && (eq_expression x2 y2))) x2 y2)  | Pstr_primitive(x1,x2), Pstr_primitive(y1,y2) -> true && ((=) x1 y1) && (eq_value_description x2 y2)  | Pstr_type(x), Pstr_type(y) -> (eq_list (fun (x1,x2) (y1,y2) -> true && ((=) x1 y1) && (eq_type_declaration x2 y2))) x y
  | Pstr_exception(x1,x2), Pstr_exception(y1,y2) -> true && ((=) x1 y1) && (eq_exception_declaration x2 y2)  | Pstr_exn_rebind(x1,x2), Pstr_exn_rebind(y1,y2) -> true && ((=) x1 y1) && (eq_longident x2 y2)  | Pstr_module(x1,x2), Pstr_module(y1,y2) -> true && ((=) x1 y1) && (eq_module_expr x2 y2)  | Pstr_recmodule(x), Pstr_recmodule(y) -> (eq_list (fun (x1,x2,x3) (y1,y2,y3) -> true && ((=) x1 y1) && (eq_module_type x2 y2) && (eq_module_expr x3 y3))) x y
  | Pstr_modtype(x1,x2), Pstr_modtype(y1,y2) -> true && ((=) x1 y1) && (eq_module_type x2 y2)  | Pstr_open(x), Pstr_open(y) -> eq_longident x y
