...
$(d)/%.depends: INCLUDES:=-I $(d) -I $(TYPOGRAPHY_DIR) -I $(FORMAT_DIR) -I $(UTIL_DIR) -I $(UTIL_DIR)/Rbuffer

PLOT_INCLUDES := -I $(TYPOGRAPHY_DIR) -I $(FORMAT_DIR) -I $(UTIL_DIR) -I $(UTIL_DIR)/Rbuffer
