...
FORMAT_INCLUDES := -I $(TYPOGRAPHY_DIR) -I $(RBUFFER_DIR) -I $(DRIVERS_DIR)/SVG -I $(d)/../Util
...
OTHER_FORMATS := $(d)/FormatArticle.ml $(d)/FormatLivre.ml $(d)/FormatThese.ml \
  $(d)/FormatLetter.ml $(d)/FormatSlides.ml $(d)/LMFormat.ml $(d)/FormatWeb.ml $(d)/Interactive.ml 
