                    ...
                    fun c  ->
                      ...
                      fun cn  ->
                        ...
                        fun _unnamed_3  ->
                          ...
                          Pstr_exn_rebind (name, ex))) (fun x  y  -> y x))
           (fun x  y  -> y x);
        Glr.apply
             ...
             (fun o  ->
                ...
                fun m  ->
                  ...
                  fun _unnamed_2  ->
                    ...
                    Pstr_open (id_loc m _loc_m))) (fun x  y  -> y x);
             ...
             (fun o  ->
                ...
                fun m  ->
                  ...
                  fun _unnamed_2  ->
                    let (_loc__unnamed_2,_unnamed_2) = _unnamed_2 in
                    let _loc = merge [_loc__unnamed_2; _loc_o; _loc_m] in
                    Psig_open (id_loc m _loc_m))) (fun x  y  -> y x);
