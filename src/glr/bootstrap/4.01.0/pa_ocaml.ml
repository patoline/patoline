...
module Make(Initial:Extension) =
  struct
                ...
                then
                  (Glr.apply
                     ...
                     (locate
                        (Glr.sequence
                           (Glr.sequence (locate (Glr.string "*" ()))
                              (locate (typexpr_lvl (next_type_prio Prod)))
                              (fun _unnamed_0  ->
                                 let (_loc__unnamed_0,_unnamed_0) =
                                   _unnamed_0 in
                                 fun te  ->
                           ...
                           (Glr.fixpoint []
                              (Glr.apply (fun x  l  -> x :: l)
                                 (Glr.sequence (locate (Glr.string "*" ()))
                                    (locate
                                       (typexpr_lvl (next_type_prio Prod)))
                                    (fun _unnamed_0  ->
                                       let (_loc__unnamed_0,_unnamed_0) =
                                         _unnamed_0 in
                                       fun te  ->
    ...
    let class_spec =
      Glr.sequence
        (Glr.sequence
           ...
           (locate (Glr.string ":" ())) (fun x  -> x)) (locate class_type)
        (fun x  -> x)
    ...
    let classtype_def =
      Glr.sequence
        (Glr.sequence
           ...
           (locate (Glr.char '=' ())) (fun x  -> x)) (locate class_body_type)
        (fun x  -> x)
                ...
                let y =
                  (Glr.apply
                     (fun c  ->
                        ...
                        let ast =
                          Ppat_construct
                            ({ txt = c; loc = _loc_c }, None, false) in
                  ...
                  (Glr.apply
                     (fun b  ->
                        ...
                        (AtomPat,
                          (loc_pat _loc (Ppat_construct (fls, None, false)))))
                     (locate bool_lit))
                  ::
                  (let y =
                     [Glr.apply
                  ...
                  (Glr.sequence (locate constr)
                     ...
                     (fun c  ->
                        ...
                        fun p  ->
                          ...
                          let ast =
                            Ppat_construct
                              ({ txt = c; loc = _loc_c }, (Some p), false) in
                          ...
                          (Glr.sequence (locate (Glr.string ":" ()))
                             ...
                             (fun te  ->
                                ...
                                fun ty  ->
                                  ...
                                  let _loc = merge _loc_te _loc_ty in
                                  (AsPat,
                                    (fun p  ->
                                 ...
                                 (fun te  ->
                                    ...
                                    fun ids  ->
                                      ...
                                      fun _unnamed_2  ->
                                        ...
                                        fun te  ->
                                          let (_loc_te,te) = te in
                                          let _loc = merge _loc_te _loc_te in
                                          (AsPat,
                                            (fun p  ->
                                               ln p _loc
                                                 (Ppat_constraint
              ...
              (Glr.sequence (locate (pattern_lvl (next_pat_prio AsPat)))
                 ...
                 (fun pat  ->
                    ...
                    fun e  ->
                      ...
                      fun l  ->
                        let (_loc_l,l) = l in
                        let _loc = merge _loc_pat _loc_l in (pat, e) :: l))
              (locate
                 (Glr.option []
                                     ...
                                     (Ppat_constraint
                                        ((loc_pat _loc
                                            (Ppat_var
                                               { txt = vn; loc = _loc_vn })),
                                          ty)) in
                                 (pat, e) :: l)) (locate poly_syntax_typexpr)
                   (fun x  -> x)) (locate right_member) (fun x  -> x))
             (locate
                (Glr.option []
                   (Glr.sequence (locate and_kw) (locate let_binding)
                      ...
                      (Glr.sequence (locate function_kw)
                         ...
                         (fun _unnamed_0  ->
                            ...
                            fun l  ->
                              ...
                              (Let,
                                (loc_expr _loc (Pexp_function ("", None, l))))))
                      :: y
                    else y) in
                 if lvl < App
                 then
      ...
      Glr.alternatives
        [Glr.sequence (locate type_kw) (locate typedef_in_constraint)
           (fun _unnamed_0  ->
              let (_loc__unnamed_0,_unnamed_0) = _unnamed_0 in
              fun tdef  ->
                let (_loc_tdef,tdef) = tdef in
                let _loc = merge _loc__unnamed_0 _loc_tdef in
                   ...
                   fun m1  ->
                     ...
                     fun _unnamed_2  ->
                       ...
                       fun m2  ->
                         ...
                         ({ txt = m1; loc = _loc_m1 },
                           (Pwith_module { txt = m2; loc = _loc_m2 }))))
             (locate (Glr.char '=' ())) (fun x  -> x))
    ...
    let module_item_base =
      Glr.alternatives
        [Glr.apply (fun e  -> let (_loc_e,e) = e in let _loc = _loc_e in e)
           (locate (alternatives extra_module_items));
        Glr.sequence
          (Glr.sequence
             (locate
        ...
        Glr.apply
          ...
          (locate expression)]
    let _ =
      set_grammar module_item
        (Glr.sequence (locate module_item_base)
           (locate
              (Glr.option None
                 (Glr.apply (fun x  -> Some x) (Glr.string ";;" ()))))
           (fun s  ->
