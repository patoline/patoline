...
module Ext(In:Extension) =
  struct
    ...
    let glr_parser =
      Glr.alternatives
        [Glr.sequence
           (Glr.sequence (locate (Glr.string "glr_locate" ()))
             ...
             (fun _unnamed_0  ->
                ...
                fun p  ->
                  ...
                  fun _unnamed_2  ->
                    ...
                    (Atom, p))) (locate end_kw) (fun x  -> x);
        Glr.sequence
          (Glr.sequence
             (Glr.sequence (locate glr_kw) (locate (Glr.char '*' ()))
                (fun _unnamed_0  ->
                   let (_loc__unnamed_0,_unnamed_0) = _unnamed_0 in
                   fun _unnamed_1  ->
                       ...
                       (Glr.alternatives
                          ...
                          Glr.apply
                            (fun _unnamed_0  ->
                               let (_loc__unnamed_0,_unnamed_0) = _unnamed_0 in
                               let _loc = _loc__unnamed_0 in ())
                            (locate else_kw)])))) (locate glr_list_rules_aux)
              (fun _unnamed_0  ->
                 let (_loc__unnamed_0,_unnamed_0) = _unnamed_0 in
                 fun r  ->
                   let (_loc_r,r) = r in
